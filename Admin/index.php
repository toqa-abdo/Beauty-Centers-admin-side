                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <form action="search.php" method="GET">
                                    ...
                                    <a href="addCat.html" class="btn float-right d-inline-block btn-dark">Add Category</a> &nbsp;&nbsp;&nbsp;
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                ...
                                { ?>
                                    <tr>
                                        <td><?php echo $row['center _id']  ?></td>
                                        <td><?php echo $row['center_name']  ?></td>
                                        <td><?php echo $row['center_email']  ?></td>
                                        <td> 
                                            <img src="../Images/<?php if(isset($row['center_image'])){ echo $row['center_image'] ;}  ?>" alt="" width='50px' height='50px'>
                                        </td>
                                       
                                        <td>
                                            <a href="delete.php?id=<?php echo $row['center _id']?>" class="btn btn-danger  text-black">Delete</a>
                                        </td>
                                    </tr>
                                <?php }  
                                }
